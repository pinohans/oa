...
--
-- Host: 127.0.0.1
-- Generation Time: 2016-10-15 13:37:12
...
--
-- 插入之前先把表清空（truncate） `think_contact`
--

TRUNCATE TABLE `think_contact`;
-- --------------------------------------------------------
...
--
-- 插入之前先把表清空（truncate） `think_customer`
--

TRUNCATE TABLE `think_customer`;
-- --------------------------------------------------------
...
--
-- 插入之前先把表清空（truncate） `think_demo`
--

TRUNCATE TABLE `think_demo`;
--
-- 转存表中的数据 `think_demo`
--
...
--
-- 插入之前先把表清空（truncate） `think_dept`
--

TRUNCATE TABLE `think_dept`;
--
-- 转存表中的数据 `think_dept`
--
...
--
-- 插入之前先把表清空（truncate） `think_dept_grade`
--

TRUNCATE TABLE `think_dept_grade`;
--
...
--
-- 插入之前先把表清空（truncate） `think_doc`
--

TRUNCATE TABLE `think_doc`;
--
-- 转存表中的数据 `think_doc`
--
...
--
-- 插入之前先把表清空（truncate） `think_duty`
--

TRUNCATE TABLE `think_duty`;
--
-- 转存表中的数据 `think_duty`
--
...
--
-- 插入之前先把表清空（truncate） `think_file`
--

TRUNCATE TABLE `think_file`;
-- --------------------------------------------------------
...
--
-- 插入之前先把表清空（truncate） `think_finance`
--

TRUNCATE TABLE `think_finance`;
--
...
--
-- 插入之前先把表清空（truncate） `think_finance_account`
--

TRUNCATE TABLE `think_finance_account`;
--
...
--
-- 插入之前先把表清空（truncate） `think_flow`
--

TRUNCATE TABLE `think_flow`;
--
-- 转存表中的数据 `think_flow`
--
...
--
-- 插入之前先把表清空（truncate） `think_flow_log`
--

TRUNCATE TABLE `think_flow_log`;
--
...
--
-- 插入之前先把表清空（truncate） `think_flow_type`
--

TRUNCATE TABLE `think_flow_type`;
--
...
--
-- 插入之前先把表清空（truncate） `think_form`
--

TRUNCATE TABLE `think_form`;
--
-- 转存表中的数据 `think_form`
--
...
--
-- 插入之前先把表清空（truncate） `think_group`
--

TRUNCATE TABLE `think_group`;
-- --------------------------------------------------------
...
--
-- 插入之前先把表清空（truncate） `think_group_user`
--

TRUNCATE TABLE `think_group_user`;
-- --------------------------------------------------------
...
--
-- 插入之前先把表清空（truncate） `think_info`
--

TRUNCATE TABLE `think_info`;
-- --------------------------------------------------------
...
--
-- 插入之前先把表清空（truncate） `think_info_scope`
--

TRUNCATE TABLE `think_info_scope`;
-- --------------------------------------------------------
...
--
-- 插入之前先把表清空（truncate） `think_info_sign`
--

TRUNCATE TABLE `think_info_sign`;
-- --------------------------------------------------------
...
--
-- 插入之前先把表清空（truncate） `think_mail`
--

TRUNCATE TABLE `think_mail`;
-- --------------------------------------------------------
...
--
-- 插入之前先把表清空（truncate） `think_mail_account`
--

TRUNCATE TABLE `think_mail_account`;
--
...
--
-- 插入之前先把表清空（truncate） `think_mail_organize`
--

TRUNCATE TABLE `think_mail_organize`;
-- --------------------------------------------------------
...
--
-- 插入之前先把表清空（truncate） `think_message`
--

TRUNCATE TABLE `think_message`;
--
...
--
-- 插入之前先把表清空（truncate） `think_node`
--

TRUNCATE TABLE `think_node`;
--
-- 转存表中的数据 `think_node`
--
...
(217, '学习', 'Task/index', 'fa fa-book', '', '', '6', 0, 0, 'badge_sum'),
...
(247, '设置', '', '', '', '', '3', 242, 0, ''),
(252, '学习任务', 'Task/index', '', '', '', '2', 217, 0, 'badge_count_task');
...
--
-- 插入之前先把表清空（truncate） `think_position`
--

TRUNCATE TABLE `think_position`;
--
...
--
-- 插入之前先把表清空（truncate） `think_push`
--

TRUNCATE TABLE `think_push`;
--
-- 转存表中的数据 `think_push`
--
...
(3221, 4, '{"type":"任务","action":"需要执行","title":"来自：石河子高新区-管理员","content":"标题：大家一起来学习！","url":"\\/index.php?m=&c=task&a=read&id=2&return_url=Task%2Findex"}', 0, 0, NULL);
...
--
-- 插入之前先把表清空（truncate） `think_rank`
--

TRUNCATE TABLE `think_rank`;
--
-- 转存表中的数据 `think_rank`
--
...
--
-- 插入之前先把表清空（truncate） `think_role`
--

TRUNCATE TABLE `think_role`;
--
-- 转存表中的数据 `think_role`
--
...
--
-- 插入之前先把表清空（truncate） `think_role_duty`
--

TRUNCATE TABLE `think_role_duty`;
--
...
--
-- 插入之前先把表清空（truncate） `think_role_node`
--

TRUNCATE TABLE `think_role_node`;
--
...
--
-- 插入之前先把表清空（truncate） `think_role_user`
--

TRUNCATE TABLE `think_role_user`;
--
...
--
-- 插入之前先把表清空（truncate） `think_schedule`
--

TRUNCATE TABLE `think_schedule`;
-- --------------------------------------------------------
...
--
-- 插入之前先把表清空（truncate） `think_songji`
--

TRUNCATE TABLE `think_songji`;
-- --------------------------------------------------------
...
--
-- 插入之前先把表清空（truncate） `think_songji_log`
--

TRUNCATE TABLE `think_songji_log`;
-- --------------------------------------------------------
...
--
-- 插入之前先把表清空（truncate） `think_supplier`
--

TRUNCATE TABLE `think_supplier`;
--
...
--
-- 插入之前先把表清空（truncate） `think_system_config`
--

TRUNCATE TABLE `think_system_config`;
--
-- 转存表中的数据 `think_system_config`
--

INSERT INTO `think_system_config` (`id`, `code`, `name`, `val`, `is_del`, `sort`, `pid`, `data_type`) VALUES
(86, 'system_name', '', '石河子高新区协同办公系统', 0, NULL, 0, 'system'),
...
--
-- 插入之前先把表清空（truncate） `think_system_folder`
--

TRUNCATE TABLE `think_system_folder`;
--
...
(5, 0, 'Info', '科技成果', '管理员/系统管理员|admin;', '管理员/系统管理员|admin;', '石河子高新区|dept_1;管理员/系统管理员|admin;Bob/主任|1;Peter/副主任|2;John/调研员|3;', '', 0, NULL),
(6, 0, 'Doc', 'dfs', '管理员/系统管理员|admin;', '管理员/系统管理员|admin;', '管理员/系统管理员|admin;管理员/系统管理员|admin;Bob/主任|1;Peter/副主任|2;John/调研员|3;', '', 0, '');
...
--
-- 插入之前先把表清空（truncate） `think_system_log`
--

TRUNCATE TABLE `think_system_log`;
--
...
--
-- 插入之前先把表清空（truncate） `think_system_tag`
--

TRUNCATE TABLE `think_system_tag`;
--
...
--
-- 插入之前先把表清空（truncate） `think_system_tag_data`
--

TRUNCATE TABLE `think_system_tag_data`;
--
...
--
-- 插入之前先把表清空（truncate） `think_task`
--

TRUNCATE TABLE `think_task`;
--
-- 转存表中的数据 `think_task`
--
...
(2, '2016-0002', NULL, '大家一起来学习！', '<p>学习学习</p>', '管理员|1;Bob|2;Peter|3;John|4;', '', '2016-10-22 13:50:00', 1, '管理员', 1, '石河子高新区', 1476450566, NULL, NULL, NULL, 10, 0, NULL),
...
--
-- 插入之前先把表清空（truncate） `think_task_log`
--

TRUNCATE TABLE `think_task_log`;
--
...
--
-- 插入之前先把表清空（truncate） `think_todo`
--

TRUNCATE TABLE `think_todo`;
-- --------------------------------------------------------
...
--
-- 插入之前先把表清空（truncate） `think_udf_field`
--

TRUNCATE TABLE `think_udf_field`;
--
...
--
-- 插入之前先把表清空（truncate） `think_udf_renew`
--

TRUNCATE TABLE `think_udf_renew`;
-- --------------------------------------------------------
...
--
-- 插入之前先把表清空（truncate） `think_udf_sales`
--

TRUNCATE TABLE `think_udf_sales`;
-- --------------------------------------------------------
...
--
-- 插入之前先把表清空（truncate） `think_udf_shop`
--

TRUNCATE TABLE `think_udf_shop`;
-- --------------------------------------------------------
...
--
-- 插入之前先把表清空（truncate） `think_udf_target`
--

TRUNCATE TABLE `think_udf_target`;
-- --------------------------------------------------------
...
(1, 'admin', '管理员', 'GLY', '21232f297a57a5a743894a0e4a801fc3', 1, 2, 'male', '0000-00-00', '0.0.0.0', 3470, '', '', '', '', '', 1222907803, 1476429784, 0, '', 1, 1, 'c81e728d9d4c2f636f067f89cc14862c'),
(2, '1', 'Bob', 'BOB', 'c4ca4238a0b923820dcc509a6f75849b', 5, 5, 'male', '1900-01-01', '127.0.0.1', NULL, NULL, '', '', '', '', 1476429824, 0, 0, NULL, 1, NULL, NULL),
...
--
-- 插入之前先把表清空（truncate） `think_user_config`
--

TRUNCATE TABLE `think_user_config`;
--
...
--
-- 插入之前先把表清空（truncate） `think_user_folder`
--

TRUNCATE TABLE `think_user_folder`;
-- --------------------------------------------------------
...
--
-- 插入之前先把表清空（truncate） `think_user_tag`
--

TRUNCATE TABLE `think_user_tag`;
--
...
--
-- 插入之前先把表清空（truncate） `think_user_tag_data`
--

TRUNCATE TABLE `think_user_tag_data`;
-- --------------------------------------------------------
...
--
-- 插入之前先把表清空（truncate） `think_work_log`
--

TRUNCATE TABLE `think_work_log`;
--
...
--
-- 插入之前先把表清空（truncate） `think_work_order`
--

TRUNCATE TABLE `think_work_order`;
-- --------------------------------------------------------
...
--
-- 插入之前先把表清空（truncate） `think_work_order_log`
--

TRUNCATE TABLE `think_work_order_log`;
--
