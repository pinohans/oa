...
--
-- Host: 127.0.0.1
-- Generation Time: 2016-11-16 08:25:54
...
INSERT INTO `think_contact` (`id`, `name`, `letter`, `company`, `dept`, `position`, `email`, `office_tel`, `mobile_tel`, `website`, `im`, `address`, `user_id`, `remark`, `is_del`) VALUES
(1, '123', '', '', '', '', '123@123.com', '123', '', '', '', '', 1, '', 0),
(2, 'aaa', 'AAA', '', '', '', 'aa@aa.com', '123', '', 'aa', '', '', 1, '', 0);
...
(6, 'a.txt', '582c0639a5b90.txt', 'task/2016-11/', 'txt', 'inode/x-empty', 0, 'd41d8cd98f00b204e9800998ecf8427e', 'da39a3ee5e6b4b0d3255bfef95601890afd80709', 0, '', 1479280185),
(7, 'a.txt', '582c067c2a6e8.txt', 'study/2016-11/', 'txt', 'inode/x-empty', 0, 'd41d8cd98f00b204e9800998ecf8427e', 'da39a3ee5e6b4b0d3255bfef95601890afd80709', 0, '', 1479280252),
(8, '新建位图图像.jpg', '582c06d56ae28.jpg', 'popup/2016-11/', 'jpg', 'image/jpeg', 1973, '0dd1afc115312a5f4a5bf8c06ef6bfe7', '0798096fdb341dbeffbb932767b371f4aeec70dc', 0, '', 1479280341);
...
(6, '#', '12', '<p>12</p>', 'admin|1|', '\r\n					<span data="emp_admin" id="emp_admin"><nobr><b title="管理员/系统管理员">管理员/系统管理员</b></nobr><b><i class="fa fa-arrow-right"></i></b></span><span data="emp_1" id="emp_1"><nobr><b title="Bob/主任">Bob/主任</b></nobr><b></b><i class="fa"></i></span>				', '', '\r\n									', '', '', '66', '', 1, 'admin', '管理员', 1, '石河子高新区', '', 1479277650, 0, 20, 0, NULL);
...
(8, 6, '1', 2, 'Bob', 22, NULL, 1479277650, 0, NULL, 0, NULL, 0);
...
(66, '81', '#', 'cs', 'cs', '', 'emp_admin|emp_1|', '<span data="emp_admin" id="emp_admin"><nobr><b title="管理员/系统管理员">管理员/系统管理员</b></nobr><b><i class="fa fa-arrow-right"></i></b></span><span data="emp_1" id="emp_1"><nobr><b title="Bob/主任">Bob/主任</b></nobr><b><i class="fa"></i></b></span>', '', '', '', '', 1479277630, 0, 0, 0, 0, 0, 14, 14, '', 1);
...
(85, '邮件', 'Mail/index', 'fa fa-envelope-o bc-mail', '', '', '1', 0, 1, 'badge_sum'),
...
(185, '审批报告', 'Flow/folder?fid=report', 'bc-flow-receive', '', '', '7', 87, 0, ''),
...
(221, '文档', 'Doc/index##', 'fa fa-inbox', 'DocFolder', '', '5', 0, 0, 'badge_sum'),
(222, '文档管理', 'Doc/folder_manage', 'fa fa-inbox', '', '', '4', 221, 0, 'badge_sum'),
(226, '成果池', 'Form/index##', 'fa fa-thumb-tack ', 'FormFolder', '', '6', 0, 0, 'badge_sum'),
...
(3348, 1, '{"type":"任务","action":"需要完成","title":"来自：管委会-Bob","content":"标题：123","url":"\\/index.php?m=&c=task&a=read&id=13&return_url=Task%2Findex"}', 0, 1479280205, NULL),
(3349, 1, '{"type":"任务","action":"需要学习","title":"来自：管委会-Bob","content":"标题：123","url":"\\/index.php?m=&c=study&a=read&id=6&return_url=Study%2Findex"}', 0, 1479280254, NULL);
...
(6, '2016-0014', NULL, '123', '<p>123</p>', '石河子高新区|dept_1;', 'MDAwMDAwMDAwMITac3M;', '2016-11-26 15:10:00', 2, 'Bob', 5, '管委会', 1479280253, NULL, NULL, NULL, 0, 0, NULL);
...
(15, 6, 2, 2, '1', '石河子高新区', 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
(2, 0, 'Info', '新闻资讯', '管理员/系统管理员|admin;', '管理员/系统管理员|admin;', '石河子高新区|dept_1;管理员/系统管理员|admin;Bob/主任|1;Peter/副主任|2;John/调研员|3;', '', 0, ''),
(3, 0, 'Info', '站内通知', '管理员/系统管理员|admin;', '石河子高新区|dept_1;', '石河子高新区|dept_1;管理员/系统管理员|admin;Bob/主任|1;Peter/副主任|2;John/调研员|3;', '', 0, NULL),
(4, 0, 'Info', '党建工作', '管理员/系统管理员|admin;', '管理员/系统管理员|admin;', '石河子高新区|dept_1;管理员/系统管理员|admin;Bob/主任|1;Peter/副主任|2;John/调研员|3;', '', 0, ''),
(5, 0, 'Info', '科技成果', '管理员/系统管理员|admin;', '管理员/系统管理员|admin;', '石河子高新区|dept_1;管理员/系统管理员|admin;Bob/主任|1;Peter/副主任|2;John/调研员|3;', '', 0, ''),
(6, 0, 'Doc', '人事档案', '管理员/系统管理员|admin;', '管理员/系统管理员|admin;', '管理员/系统管理员|admin;管理员/系统管理员|admin;Bob/主任|1;Peter/副主任|2;John/调研员|3;', '', 1, ''),
...
(61, 1, 1479266820, 5, NULL),
(62, 2, 1479266820, 0.385596, NULL),
(63, 1, 1479276002, 5, NULL),
(64, 2, 1479276002, 0.385596, NULL),
(65, 1, 1479281131, 8, NULL),
(66, 2, 1479281131, 0.387478, NULL);
...
(9, '2016-0009', NULL, '正在执行的项目', '<p>2222czxczxczxc</p>', '管理员|1;', '', '2016-11-06 22:53:00', 1, '管理员', 1, '石河子高新区', 1477666413, 1477730072, NULL, NULL, 0, 1, NULL),
(10, '2016-0010', NULL, 'aaa', '<p>123</p>', 'Bob|2;', '', '2016-11-20 14:58:00', 1, '管理员', 1, '石河子高新区', 1479279502, NULL, NULL, NULL, 0, 0, NULL),
(11, '2016-0011', NULL, 'a123', '<p>123</p>', '党工委|dept_6;', '', '0000-00-00 00:00:00', 1, '管理员', 1, '石河子高新区', 1479279553, NULL, NULL, NULL, 0, 0, NULL),
(12, '2016-0012', NULL, 'das', '<p>dsa</p>', '管委会|dept_5;', '', '0000-00-00 00:00:00', 1, '管理员', 1, '石河子高新区', 1479279602, NULL, NULL, NULL, 0, 0, NULL),
(13, '2016-0013', NULL, '123', '<p>123</p>', '石河子高新区|dept_1;', 'MDAwMDAwMDAwMITKc3M;', '2016-11-16 15:09:00', 2, 'Bob', 5, '管委会', 1479280205, NULL, NULL, NULL, 0, 0, NULL);
...
(21, 10, 1, 1, '2', 'Bob', 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(22, 11, 2, 1, '6', '党工委', 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(23, 12, 2, 1, '5', '管委会', 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(24, 13, 2, 2, '1', '石河子高新区', 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
(1, 'admin', '管理员', 'GLY', '21232f297a57a5a743894a0e4a801fc3', 1, 2, 'male', '0000-00-00', '0.0.0.0', 3491, '', '', '', '', '', 1222907803, 1476429784, 0, '', 1, 1, 'c81e728d9d4c2f636f067f89cc14862c'),
(2, '1', 'Bob', 'BOB', 'c4ca4238a0b923820dcc509a6f75849b', 5, 5, 'male', '1900-01-01', '0.0.0.0', NULL, 'Uploads/emp_pic/2.jpeg', '', '', '', '', 1476429824, 1479280349, 0, NULL, 1, NULL, NULL),
...
--
-- 转存表中的数据 `think_user_tag_data`
--

INSERT INTO `think_user_tag_data` (`row_id`, `tag_id`, `controller`) VALUES
(1, 22, 'Contact'),
(2, 22, 'Contact');
...
--
ALTER TABLE `think_flow_type`
  MODIFY `id` smallint(3) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=67;
--
